    ...
    <section className="bg-white">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
          ...
          <p className="font-light brand_primary__color sm:text-xl ">
            We have tried to answer some of React related question, Hope it will
            be helpful.
          </p>
        </div>
        <div className="grid gap-8 lg:grid-cols-2">
          <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md ">
            ...
            <h2 className="mb-2 text-2xl font-bold tracking-tight brand_primary__color ">
              <a href="#">What is cors</a>
            </h2>
            <p className="mb-5 font-light brand_primary__color ">
              Cross-origin resource (cors) sharing is a mechanism that allows
          ...
          <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md ">
            ...
            <p className="mb-5 font-light brand_primary__color ">
              ...
              Twitter, and more. Auth0, MongoDB, Passport and Okta are the most
          ...
          <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md ">
            ...
            <h2 className="mb-2 text-2xl font-bold tracking-tight brand_primary__color ">
              <a href="#">How does the private route work?</a>
            </h2>
            <p className="mb-5 font-light brand_primary__color ">
          ...
          <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md ">
            ...
            <h2 className="mb-2 text-2xl font-bold tracking-tight brand_primary__color ">
              <a href="#">What is Node? How does Node work?</a>
            </h2>
            <p className="mb-5 font-light brand_primary__color ">
